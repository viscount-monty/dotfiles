...
if [ "$color_prompt" = yes ]; then
    PS1='${debian_chroot:+($debian_chroot)}\[\033[0;34m\]\u@\h\[\033[00m\]:\[\033[0;35m\]\w\[\033[00m\]\$ '
...
# Change colour of directories for ls command
# Blue = 34
# Green = 32
# Light Green = 1;32
# Cyan = 36
...
# Add python path
export PYTHONPATH="${PYTHONPATH}:/home/monty/.local/bin"
